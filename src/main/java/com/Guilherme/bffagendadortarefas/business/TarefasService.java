...
import com.Guilherme.bffagendadortarefas.infrastructure.client.TarefasClient;
...
public class TarefasService {
    ...
    public List<TarefasDTOResponse> buscaTarefasAgendadasPorPeriodo(LocalDateTime dataInicial, LocalDateTime dataFinal, String token){
        return tarefasClient.buscaDeListaTarefasPorPeriodo(dataInicial,dataFinal,token);
    }
